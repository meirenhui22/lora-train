...
$lr_scheduler_num_cycles = 2 # restarts nums | 余弦退火重启次数，仅在 lr_scheduler 为 cosine_with_restarts 时需要填写这个值
...
$output_name = "flux-test-lora24G" # output model name | 模型保存名称
